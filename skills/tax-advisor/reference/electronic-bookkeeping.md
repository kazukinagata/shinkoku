...
| 見読可能性 | **適合** | CLI JSON 出力 + trial-balance/P&L/B&S 生成で対応 |
| ダウンロード対応 | **適合** | `ledger search` でデータエクスポート可能 |
...
| 相互関連性の確保 | **適合** | `account_code` 外部キー + `general-ledger` コマンドで仕訳帳⇔総勘定元帳の関連あり |
