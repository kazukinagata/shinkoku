...
INCOME_TAX_FORM_B: dict[str, dict] = {
    ...
    "earthquake_insurance_deduction": {"x": 95 * mm, "y": 159 * mm, "font_size": 8, "type": "number"},
...
for i in range(10):
    ...
    DEDUCTION_DETAIL_FORM[f"line_{i}_name"] = {
        "x": 30 * mm, "y": y_offset, "font_size": 8, "type": "text",
    }
    DEDUCTION_DETAIL_FORM[f"line_{i}_amount"] = {
        "x": 170 * mm, "y": y_offset, "font_size": 8, "type": "number",
    }
