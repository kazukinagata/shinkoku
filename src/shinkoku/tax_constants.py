...
PENSION_DEDUCTION_UNDER_65: list[tuple[int, int, int]] = [
    (700_000, 100, 0),  # ≤70万: 全額控除（R7改正: 60万→70万）
    (1_300_000, 0, 700_000),  # 70万超〜130万: 70万
...
PENSION_DEDUCTION_OVER_65: list[tuple[int, int, int]] = [
    (1_300_000, 100, 0),  # ≤130万: 全額控除（R7改正: 110万→130万）
    (3_300_000, 0, 1_300_000),  # 130万超〜330万: 130万
